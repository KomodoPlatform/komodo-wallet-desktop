...
QtObject {
    ...
    readonly property string colorWalletsHighlightGradient1:  dark_theme ? "#FF1B5E7D" : "#FF1B5E7D"
    ...
    readonly property string colorSidebarHighlightGradient1:  dark_theme ? "#801B5E7D" : "#801B5E7D"
