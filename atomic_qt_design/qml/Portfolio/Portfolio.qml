...
ColumnLayout {
    ...
    function getColor(data) {
        ...
        if(General.validFiatRates(data, fiat) && data.change_24h !== 0)
            return data.change_24h > 0 ? Style.colorGreen : Style.colorRed
    ...
    DefaultListView {
        ...
        delegate: Rectangle {
            ...
            DefaultText {
                ...
                text_value: API.get().empty_string + (General.validFiatRates(modelData, API.get().current_currency) ? General.formatPercent(change_24h) : '-')
