...
SetupPage {
    ...
    function submitGuess(field) {
        if(validGuessField(field)) {
            ...
            if(field.text === getWords()[current_word_idx]) {
                ...
                guess_text_error = API.get().settings_pg.empty_string + (qsTr("Wrong word, please check again"))
            }
        }
    ...
    function onClickedCreate(password, generated_seed, wallet_name) {
        if(API.get().create(password, generated_seed, wallet_name)) {
            ...
            text_error = API.get().settings_pg.empty_string + (qsTr("Failed to create a wallet"))
            return false
        }
    }
    ...
    content: ColumnLayout {
        ...
        DefaultText {
            text_value: API.get().settings_pg.empty_string + (qsTr("New User"))
        }
        ...
        ColumnLayout {
            ...
            TextAreaWithTitle {
                ...
                title: API.get().settings_pg.empty_string + (qsTr("Generated Seed"))
            ...
            FloatingBackground {
                ...
                Column {
                    ...
                    DefaultText {
                        ...
                        text_value: API.get().settings_pg.empty_string + (qsTr("Important: Back up your seed phrase before proceeding!"))
                    }
                    ...
                    DefaultText {
                        ...
                        horizontalAlignment: Text.AlignHCenter
                        anchors.horizontalCenter: parent.horizontalCenter
                        text_value: API.get().settings_pg.empty_string + (qsTr("We recommend storing it offline."))
            ...
            TextAreaWithTitle {
                ...
                title: API.get().settings_pg.empty_string + (qsTr("Confirm Seed"))
                field.placeholderText: API.get().settings_pg.empty_string + (qsTr("Enter the generated seed here"))
                onReturn: completeForm
            }
            ...
            RowLayout {
                ...
                PrimaryButton {
                    id: continue_button
                    Layout.fillWidth: true
                    text: API.get().settings_pg.empty_string + (qsTr("Continue"))
        ...
        ColumnLayout {
            ...
            FloatingBackground {
                ...
                Column {
                    ...
                    DefaultText {
                        width: parent.width - 40
                        anchors.horizontalCenter: parent.horizontalCenter
                        text_value: API.get().settings_pg.empty_string + (qsTr("Let's double check your seed phrase"))
                    }

                    DefaultText {
                        width: parent.width - 40
                        anchors.horizontalCenter: parent.horizontalCenter
                        text_value: API.get().settings_pg.empty_string + (qsTr("Your seed phrase is important - that's why we like to make sure it's correct. We'll ask you three different questions about your seed phrase to make sure you'll be able to easily restore your wallet whenever you want."))
                        font.pixelSize: Style.textSizeSmall4
                        color: Style.colorWhite4
                    }
                }
            ...
            TextFieldWithTitle {
                id: input_seed_word
                title: API.get().settings_pg.empty_string + (qsTr("What's the %n. word in your seed phrase?", "", current_word_idx + 1))
                field.placeholderText: API.get().settings_pg.empty_string + (qsTr("Enter the %n. word", "", current_word_idx + 1))
            ...
            RowLayout {
                DefaultButton {
                    Layout.fillWidth: true
                    text: API.get().settings_pg.empty_string + (qsTr("Go back and check again"))
            ...
            DefaultText {
                text_value: API.get().settings_pg.empty_string + (guess_text_error)
                color: Style.colorRed
                visible: text !== ''
            }
        }
