        ...
        RowLayout // Order Info
        {
            ...
            DefaultTooltip {
                ...
                ModalLoader {
                    ...
                    sourceComponent: CannotEnableCoinModal {
                        coin_to_enable_ticker: cannot_enable_coin_modal.coin_to_enable_ticker
                    }
                }
