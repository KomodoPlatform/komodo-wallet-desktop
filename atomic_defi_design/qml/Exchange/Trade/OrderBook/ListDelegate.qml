    ...
    RowLayout {
        ...
        DefaultTooltip {
            ...
            contentItem: DefaultText {
                text_value: qsTr("This order require a minimum amount of %1 %2 - <br>You don't have enough funds (%3)").arg(min_volume).arg(API.app.trading_pg.market_pairs_mdl.left_selected_coin).arg(API.app.trading_pg.orderbook.base_max_taker_vol.decimal)
