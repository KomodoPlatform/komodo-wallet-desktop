    ...
    function __chart(context){
        ...
        this.Line = function(data,options){
            ...
            chart.Line.defaults = {
                ...
                scaleStepWidth : 20,
                scaleStartValue : 20,
                scaleLineColor : theme.dexBoxBackgroundColor,
                scaleLineWidth : 1,
                scaleShowLabels : true,
                scaleLabel : "<%=value%>",
                scaleFontFamily : theme.textType.fontFamily,
                scaleFontSize : 9,
                scaleFontStyle : "normal",
                scaleFontColor : theme.foregroundColor,
                scaleShowGridLines : true,
                scaleGridLineColor : theme.dexBoxBackgroundColor,
