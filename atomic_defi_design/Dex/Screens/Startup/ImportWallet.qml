                    ...
                    onToggled:
                    {
                        if (allow_custom_seed.checked)
                        {
                            let dialog = app.getText(
                            {
                                ...
                                validator: (text) =>
                                {
                                    if ([qsTr("i understand"), qsTr("я понимаю"), qsTr("je comprends"), qsTr("entiendo"), qsTr("anladım"), qsTr("ich verstehe"), ].includes(text.toLowerCase()))
                                    {
                                    ...
                                    return [qsTr("i understand"), qsTr("я понимаю"), qsTr("je comprends"), qsTr("entiendo"), qsTr("anladım"), qsTr("ich verstehe"), ].includes(text.toLowerCase())
                                },
