...
ColumnLayout
{
    ...
    property int           scrollable_shrink:   180
    ...
    property var scrollable_height: window.height - _title.height - _header.height - _footer.height - titleTopMargin * 2 - topMarginAfterTitle - scrollable_shrink
