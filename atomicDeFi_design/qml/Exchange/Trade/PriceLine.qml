...
RowLayout {
    ...
    ColumnLayout {
        ...
        DefaultText {
            Layout.alignment: Qt.AlignHCenter
            text_value: API.get().settings_pg.empty_string + (qsTr("Exchange rate") + (orderIsSelected() ? (" (" + qsTr("Selected") + ")") : ""))
            font.pixelSize: fontSize
        }
        ...
        DefaultText {
            Layout.alignment: Qt.AlignHCenter
            text_value: API.get().settings_pg.empty_string + ("1 " + right_ticker + " = " + General.formatCrypto("", General.formatDouble(1 / parseFloat(price)), left_ticker))
        ...
        DefaultText {
            Layout.alignment: Qt.AlignHCenter
            text_value: API.get().settings_pg.empty_string + ("1 " + left_ticker + " = " + General.formatCrypto("", price, right_ticker))
            font.pixelSize: fontSize
        }
    }
    ...
    ColumnLayout {
        ...
        DefaultText {
            ...
            text_value: API.get().settings_pg.empty_string + ((price_diff > 0 ? qsTr("Expensive") : qsTr("Expedient")) + ":&nbsp;&nbsp;&nbsp;&nbsp;" + qsTr("%1 compared to CEX", "PRICE_DIFF%").arg("<b>" + General.formatPercent(limitDigits(price_diff)) + "</b>"))
            font.pixelSize: fontSize
        }
        ...
        RowLayout {
            Layout.alignment: Qt.AlignHCenter
            DefaultText {
                text_value: API.get().settings_pg.empty_string + (General.formatPercent(line_scale))
                font.pixelSize: fontSize
            }
    ...
    ColumnLayout {
        ...
        DefaultText {
            Layout.alignment: Qt.AlignHCenter
            text_value: API.get().settings_pg.empty_string + (General.cex_icon + " " + qsTr("CEXchange rate"))
            font.pixelSize: fontSize
        ...
        DefaultText {
            Layout.alignment: Qt.AlignHCenter
            text_value: API.get().settings_pg.empty_string + ("1 " + right_ticker + " = " + General.formatCrypto("", General.formatDouble(1 / parseFloat(cex_price)), left_ticker))
            font.pixelSize: fontSizeBigger
            font.bold: true
        }
        ...
        DefaultText {
            Layout.alignment: Qt.AlignHCenter
            text_value: API.get().settings_pg.empty_string + ("1 " + left_ticker + " = " + General.formatCrypto("", cex_price, right_ticker))
            font.pixelSize: fontSize
        }
    }
}
