...
namespace
{
	...
	std::string mm2_error_category_impl::message(int code) const noexcept
	{
		...
		case mm2_error::rpc_withdraw_error:
			return
				"An RPC error occur when processing the withdraw request, please check your request or the application log.";
		case mm2_error::rpc_send_raw_transaction_error:
			return
				"An RPC error occur when processing the send_raw_transaction request, please check your tx_hex or the application log.";
