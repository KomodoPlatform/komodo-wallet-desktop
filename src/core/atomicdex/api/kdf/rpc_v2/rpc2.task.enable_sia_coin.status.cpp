...
//! Implementation 2.0 RPC [enable_sia_coin_status]
namespace atomic_dex::kdf
{
    ...
    void
    from_json(const nlohmann::json& j, enable_sia_coin_status_answer& answer)
    {
        if (j.count("error") >= 1)
        {
            answer.error = j;
        ...
        else
        {
            ...
            {
                answer.result = j.at("result").get<enable_sia_coin_status_answer_success>();
            }
        }
    }
} // namespace atomic_dex::kdf
