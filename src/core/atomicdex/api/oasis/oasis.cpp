...
namespace
{
    const std::string g_oasis_endpoint = "https://api-sandbox.nimiqoasis.com/v1";
...
namespace atomic_dex::oasis::api
{
    ...
    create_htlc(hashed_timed_lock_contract&& htlc_request)
    {
        ...
        return g_oasis_client->request(req);
    }
} // namespace atomic_dex::oasis::api
