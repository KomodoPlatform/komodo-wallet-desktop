...
namespace atomic_dex
{
    class notification_manager final : public QObject
    {
      ...
      public:
        ...
        void on_missmatch_custom_coins_configuration(const missmatch_configuration_custom_coin& evt);
      ...
      signals:
        ...
        void missmatchCustomCoinConfiguration(QString asset, QString human_date, qint64 timestamp);
